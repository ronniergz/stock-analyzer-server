      ...
      <Modal isOpen={this.props.modalStatus} toggle={this.props.onModal}>
        ...
        <ModalBody>
          ...
          <Form onSubmit={this.handleSubmit}>
            <FormText m={5} className="justify-content-center"> Edit existing equity.</FormText>
            <FormGroup className="mb-0" row>
              <Label for="symbol" xs={6}>
                Future P/E
              </Label>
              <InputGroup className="col-6">
                <Input required type="text" name="futPe" value={this.props.futPe} onChange={this.handleChange} step=".01"></Input>
              </InputGroup>
            </FormGroup>
            ...
            <FormGroup className="mb-0" row>
              ...
              <InputGroup className="col-6">
                <Input required type="text" name="growth" maxLength="2" value={this.props.growth} onChange={this.handleChange}></Input>
